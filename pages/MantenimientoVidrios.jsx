...
const Mantencion = () => {
  return (
    <div>
      <Carrusel heading='Servicios' message='Explora nuestros servicios y obtén una cotización' />
      <h1 className="text-3xl md:text-5xl font-bold text-center mt-10 mb-5 md:mb-8">
        Mantenimiento y Reparación de Ventanas de Vidrio
      </h1>
      <div>
      ...
      <div className="mx-12 mb-20 grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 md:mt-8 justify-center">
        <div className="border border-gray-300 p-4 rounded-md text-center flex flex-col justify-center items-center transition-transform transform-gpu hover:scale-110">
      ...
      <h1 className="text-3xl md:text-3xl font-bold text-center mb-4 md:mb-8">
